...
- **Modeling**. Pada proses pengembangan model digunakan pendekatan _Deep Learning Credit Scoring_ menggunakan TensorFlow Functional API dengan implementasi komponen kustom sebagai berikut:
  ...
  - **Custom Component Development**. Pada tahap ini diterapkan _Custom Layer, Custom Loss Function_, dan _Custom Callback_ untuk meningkatkan kemampuan model dalam melakukan ekstraksi fitur, menangani ketidakseimbangan data, dan mengoptimalkan proses pelatihan.
