...
# dipakai untuk menghitung DSR & explanation
Parental_Income_IDR_Monthly = float(input("Enter parental income monthly: "))
...
numerical_features = ['Payment_History', 'Loan_Amount_IDR', 'Course_Credits', 'Liability', 'Attendance', 'Grade_Average', 'DSR']

categorical_features = ['Home_Ownership', 'Loan_Purpose', 'Previous_Loan', 'Working_Student', 'Parent_Job', 'Residence_Type']
